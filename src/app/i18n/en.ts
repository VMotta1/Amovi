export const en = {
  ...
  notifications: {
    ...
    leftoverSuggestion: "Move leftover to your goal",
  ...
  home: {
    ...
    monthlyBudgetStatus: "This Month's Budget Status",
    noBudgetCategories: "No budget categories yet. Set category budgets to track your monthly progress.",
    remainingBudget: "{{amount}} left",
    overBudget: "{{amount}} over",
    budgetUsed: "{{value}}% used",
    ...
    contributionNotePlaceholder: "Optional note",
  ...
  budgetGoalsPage: {
    ...
    initialSavedAmountHelp: "Optional starting amount already saved for this goal",
    ...
    initialContribution: "Initial amount",
    currentAmountManagedByContributions: "Current amount is managed by contribution history.",
